function [Solm]=Solm(Gfun,Ffun,sing,A,h,t,dt)
%{
    ...
    Args:
        ...
        t - Path for Numerical Integration
        dt - Derivative of Path for Numerical Integration
    Returns:
...
%}
    ...
    for m=-N:N;
        ...
        for n=-N:N
            ...
            Tp=dt(n*h);             %Derivative of Warped Path
